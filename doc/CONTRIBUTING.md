...
Thank you for your interest in contributing to SmartTutor! We welcome developers of all skill levels to help build the next-generation intelligent learning companion.
...
`git config smarttutor.allowMainCommit true`, then remove the setting immediately
afterward.

Use a separate Git worktree for each feature (`git worktree add ../SmartTutor-<task>
