...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "Docker settings: "
        f"backend={values['SMARTTUTOR_DOCKER_BACKEND_PORT']} "
        f"frontend={values['SMARTTUTOR_DOCKER_FRONTEND_PORT']} "
        f"pocketbase={values['SMARTTUTOR_DOCKER_POCKETBASE_PORT']}",
        file=sys.stderr,
    )
