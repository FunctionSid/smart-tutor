...
from smarttutor.config.settings import settings
from smarttutor.logging import LLMStats
from smarttutor.services.config import get_agent_params
...
class BaseAgent(ABC):
    ...
    def __init__(
        ...
        self.logger = logging.getLogger(f"smarttutor.{logger_name}")
