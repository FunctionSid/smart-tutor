...
from smarttutor.agents.chat.context_budget import LLMRequestSnapshot
from smarttutor.agents.chat.dsml_tool_calls import DSMLStreamFilter, extract_dsml_tool_calls
from smarttutor.core.agentic.messages import assistant_message_with_tool_calls
from smarttutor.core.agentic.tool_call_stream import ToolCallAccumulator
from smarttutor.core.agentic.tool_dispatch import DispatchOutcome
from smarttutor.core.agentic.usage import message_content_chars, record_streamed_usage
from smarttutor.core.context import UnifiedContext
from smarttutor.core.stream_bus import StreamBus
from smarttutor.core.trace import build_trace_metadata, merge_trace_metadata, new_call_id
from smarttutor.services.llm import LLMProviderTransportError, clean_thinking_tags
from smarttutor.services.llm.capabilities import threads_session_id
from smarttutor.services.llm.multimodal import should_degrade_to_text, strip_image_parts_inplace
from smarttutor.services.llm.request_compat import (
...
if TYPE_CHECKING:  # pragma: no cover
    from smarttutor.agents.chat.agentic_pipeline import AgenticChatPipeline
    ...
    async def _call_llm(
        ...
        *,
        ...
        if threads_session_id(self.pipeline.binding):
            kwargs["smarttutor_session_id"] = self.context.session_id
