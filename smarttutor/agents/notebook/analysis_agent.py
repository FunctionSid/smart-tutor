...
from smarttutor.core.trace import build_trace_metadata, derive_trace_metadata, new_call_id
...
from smarttutor.services.prompt.manager import get_prompt_manager
...
class NotebookAnalysisAgent:
    ...
    def __init__(self, language: str = "en") -> None:
        ...
        # Prompts come from smarttutor/agents/notebook/prompts/{en,zh}/analysis_agent.yaml
