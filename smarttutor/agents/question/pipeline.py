...
to :mod:`smarttutor.core.agentic` and the shared tool-composition policy.
"""
...
from smarttutor.core.agentic.labels import find_inline_labels
from smarttutor.core.agentic.tool_dispatch import MAX_PARALLEL_TOOL_CALLS
from smarttutor.core.agentic.usage import record_streamed_usage
    ...
    async def _summarize_tool_result(
        ...
        *,
        ...
        meta = build_trace_metadata(
            ...
            label=self._t("labels.reflecting", default="SmartTutor Reflecting..."),
        ...
        await stream.progress(
            self._t("labels.reflecting", default="SmartTutor Reflecting..."),
            source=SOURCE,
            stage=STAGE_EXPLORING,
