...
from smarttutor.agents._shared.capability_result import emit_capability_result
...
from smarttutor.agents.research.data_structures import (
    DynamicTopicQueue,
    ToolTrace,
    TopicBlock,
    TopicStatus,
)
from smarttutor.agents.research.utils.citation_manager import CitationManager
...
from smarttutor.core.agentic.tool_dispatch import (
...
from smarttutor.services.config import parse_language
from smarttutor.services.llm import get_llm_config, prepare_multimodal_messages
from smarttutor.services.path_service import get_path_service
from smarttutor.services.prompt import get_prompt_manager
from smarttutor.services.prompt.language import append_language_directive
from smarttutor.services.sandbox import exec_capability_available
from smarttutor.utils.json_parser import parse_json_response
...
class ResearchPipeline:
    ...
    LLM call goes through :mod:`smarttutor.core.agentic` primitives. The
    ...
    def __init__(
        ...
        *,
        ...
        if self.kb_name:
            try:
                from smarttutor.knowledge.kb_types import OBSIDIAN_KB_TYPE
                from smarttutor.multi_user.knowledge_access import resolve_kb_metadata
    ...
    async def _prepare_pageindex_tools(self) -> None:
        from smarttutor.services.rag.pipelines.pageindex.tools import (
...
class _RephraseLoopHost:
    ...
    async def resolve_pause(self, dispatch: DispatchOutcome) -> bool:
        from smarttutor.agents.chat.agentic_pipeline import (
