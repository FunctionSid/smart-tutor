...
Why live here vs inside ``smarttutor.partners.channels``?
...
from smarttutor.services.partners.manager import _is_secret_field
...
def all_channel_schemas() -> dict[str, dict[str, Any]]:
    ...
    """
    from smarttutor.partners.channels.registry import discover_all_with_errors
