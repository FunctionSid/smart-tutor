...
from smarttutor.api.utils.http_headers import content_disposition
from smarttutor.book import (
    BlockType,
    BookProposal,
    Spine,
    get_book_engine,
)
from smarttutor.book.estimate import chapter_basis
from smarttutor.book.export import export_filename, render_book_markdown
from smarttutor.book.models import ContentType, LearningCapture, LearningCaptureStatus
from smarttutor.book.storage import get_book_storage
from smarttutor.book.streaming import SOURCE as BOOK_SOURCE
...
async def book_websocket(ws: WebSocket) -> None:
    ...
    **Actions** — run an engine operation and reply with a single result::
    ...
    Actions publish into the book's own stream (see :mod:`smarttutor.book.event_hub`),
    ...
    from smarttutor.book.event_hub import get_book_bus
