...
Validation lives in
:mod:`smarttutor.services.config.capabilities_settings` so the API stays
...
async def get_capabilities_settings_endpoint() -> dict[str, Any]:
    from smarttutor.services.config.capabilities_settings import capabilities_settings_dict
...
async def put_capabilities_settings(payload: dict[str, Any]) -> dict[str, Any]:
    from smarttutor.services.config.capabilities_settings import save_capabilities_settings
