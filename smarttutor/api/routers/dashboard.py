...
come from :mod:`smarttutor.services.suggestions`, which reads memory.
...
async def get_starter_suggestions():
    ...
    :mod:`smarttutor.services.suggestions`.
    """
    from smarttutor.services.suggestions import get_suggestions
...
async def refresh_starter_suggestions():
    ...
    different set.
    """
    from smarttutor.services.suggestions import refresh_suggestions
