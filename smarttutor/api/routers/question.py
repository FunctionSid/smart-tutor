...
from smarttutor.agents.question import AgentCoordinator
from smarttutor.api.utils.task_id_manager import TaskIDManager
from smarttutor.logging import (
    ProcessLogEvent,
    bind_log_context,
...
from smarttutor.services.settings.interface_settings import get_response_language
from smarttutor.tools.question import mimic_exam_questions
                ...
                if clean_message:
                    try:
                        event = ProcessLogEvent(
                            ...
                            logger="smarttutor.question.stdout",
