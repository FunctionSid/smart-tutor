...
A thin adapter over :mod:`smarttutor.reading`: it validates HTTP inputs, maps
...
from smarttutor.reading import (
    ANNOTATION_COLORS,
    Annotation,
    MaterialNotFound,
    ReadingError,
...
async def supported_formats() -> SupportedFormats:
    ...
    from smarttutor.reading.extract import RAW_VIEW_EXTENSIONS
    from smarttutor.utils.document_extractor import SUPPORTED_DOC_EXTENSIONS
...
async def export(
    ...
    export keeps working outside SmartTutor; ``markdown`` returns the marks as
