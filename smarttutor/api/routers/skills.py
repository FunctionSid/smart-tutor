...
from smarttutor.multi_user.skill_access import (
...
async def hub_catalog(hub: str = "eduhub", q: str = "", limit: int = 50) -> dict[str, object]:
    ...
    The web "Import from EduHub" panel renders these rows in SmartTutor's own
    ...
    from smarttutor.services.skill.hub import ClawHubProvider, HubError, get_hub_provider
...
async def install_skill(payload: InstallSkillRequest) -> dict[str, object]:
    ...
    lives in :func:`smarttutor.services.skill.hub.install_from_hub`.
    """
    import asyncio
