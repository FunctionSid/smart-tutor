...
from smarttutor.services.cli_apps import (
    CliAppEntry,
    catalog_pin,
    category_counts,
    get_entry,
...
from smarttutor.services.cli_apps.state import (
    InstalledApp,
    disabled_apps,
    load_installed,
    set_app_enabled,
...
async def install(app_id: str) -> dict[str, Any]:
    ...
    from smarttutor.services.cli_apps.installer import install_app
...
async def uninstall(app_id: str) -> dict[str, Any]:
    ...
    from smarttutor.services.cli_apps.installer import uninstall_app
