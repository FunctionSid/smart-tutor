...
from smarttutor.services.mcp import MCPServerConfig, get_mcp_manager, load_mcp_config, oauth
from smarttutor.services.mcp.catalog import (
    build_server_config,
    category_counts,
    get_entry,
    search_catalog,
...
from smarttutor.services.mcp.secrets import configured_fields, delete_secrets, store_secrets
from smarttutor.services.mcp.user_config import (
...
def _resolve_for_probe(owner: str, config: MCPServerConfig) -> MCPServerConfig:
    ...
    """
    from smarttutor.services.mcp.manager import MCPConnectionManager
...
def _extract_credentials(
    ...
    """
    from smarttutor.services.mcp.secrets import SECRET_REFERENCE_RE, secret_reference
