...
from smarttutor.runtime import memory_probe
...
from smarttutor.services.llm import get_llm_config, get_token_limit_kwargs
...
async def get_memory_usage():
    """Resident memory of the running SmartTutor process tree.
...
async def test_search_connection():
    ...
    try:
        ...
        result = web_search("SmartTutor health check", provider=search_config.provider)
        response_time = (time.time() - start_time) * 1000
