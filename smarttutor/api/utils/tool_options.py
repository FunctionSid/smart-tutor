...
from smarttutor.core.i18n import current_language
from smarttutor.i18n.metadata_i18n import localized_description, tool_description_i18n
...
async def build_tool_options(
    *,
    ...
    from smarttutor.runtime.registry.deferred_tools import provider_identity
    from smarttutor.runtime.registry.tool_registry import get_tool_registry
    from smarttutor.tools.builtin import CONFIGURABLE_BUILTIN_TOOL_NAMES
