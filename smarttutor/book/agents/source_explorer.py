...
from smarttutor.agents.base_agent import BaseAgent
...
class SourceExplorer(BaseAgent):
    ...
    def __init__(
        ...
        # smarttutor/agents/research/pipeline.py:403.
    ...
    async def explore(
        ...
        *,
        ...
        from smarttutor.services.rag.pipelines.pageindex import (
    ...
    def partition_knowledge_bases(kb_list: list[str]) -> tuple[list[str], list[str]]:
        ...
        for kb in kb_list:
            try:
                from smarttutor.knowledge.kb_types import supports_rag_retrieval
    ...
    async def _retrieve_pageindex_chunks(
        ...
        *,
        ...
        if not kb_list:
            return []
        from smarttutor.services.rag.pipelines.pageindex.reasoning import (
    ...
    def _collect_non_kb_chunks(self, inputs: BookInputs) -> list[SourceChunk]:
        ...
        try:
            if inputs.notebook_refs:
                from smarttutor.services.notebook import notebook_manager
