...
Reuses:
- ``smarttutor.services.session.get_sqlite_session_store`` for chat history
- ``smarttutor.services.notebook.notebook_manager`` for notebook records
- ``smarttutor.agents.notebook.NotebookAnalysisAgent`` for context distillation
"""
