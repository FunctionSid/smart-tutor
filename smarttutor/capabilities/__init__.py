...
:mod:`smarttutor.capabilities` (``solve``, ``mastery``). The chat loop imports
...
from smarttutor.capabilities.protocol import KnowledgeCapability, LoopCapability, PromptBlock
from smarttutor.capabilities.registry import (
    LOOP_CAPABILITIES,
