...
from smarttutor.knowledge.kb_types import IMA_KB_TYPE
...
def resolve_client(kb_ref: str, *, for_write: bool = False):
    ...
    from smarttutor.services.rag.pipelines.ima.client import ImaClient
    from smarttutor.services.rag.pipelines.ima.config import resolve_kb_config
    from smarttutor.services.rag.provider_binding import load_kb_config_entry
