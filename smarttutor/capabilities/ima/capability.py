...
IMA library (resolved by :mod:`smarttutor.capabilities.ima.binding`).

Unlike the Obsidian and subagent capabilities this is a *plain*
:class:`~smarttutor.capabilities.protocol.LoopCapability`, not a
:class:`~smarttutor.capabilities.protocol.KnowledgeCapability`: it **adds** its
...
from smarttutor.capabilities.ima.binding import ima_bindings
from smarttutor.capabilities.ima.tools import BINDINGS_KWARG, IMA_TOOL_NAMES
