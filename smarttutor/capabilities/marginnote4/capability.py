...
library (resolved by :mod:`smarttutor.capabilities.marginnote4.binding`). As a
...
from smarttutor.capabilities.marginnote4.binding import (
    marginnote_binding,
    marginnote_kb_refs,
)
from smarttutor.capabilities.marginnote4.tools import MARGINNOTE_TOOL_NAMES
