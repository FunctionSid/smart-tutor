...
(via :class:`~smarttutor.capabilities.marginnote4.capability.MarginNoteCapability`,
...
:class:`~smarttutor.capabilities.marginnote4.store.MarginNoteStore` methods.
...
from smarttutor.capabilities.marginnote4.models import ALL_TYPES
from smarttutor.capabilities.marginnote4.store import MarginNoteStore
