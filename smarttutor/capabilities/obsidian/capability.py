...
vault (resolved by :mod:`smarttutor.capabilities.obsidian.binding`). As a
...
from smarttutor.capabilities.obsidian.binding import obsidian_vault_refs, vault_for_turn
from smarttutor.capabilities.obsidian.tools import OBSIDIAN_TOOL_NAMES
