...
:class:`~smarttutor.capabilities.obsidian.capability.ObsidianCapability`, which
...
:mod:`smarttutor.capabilities.obsidian.vault` operations.
...
from smarttutor.capabilities.obsidian import vault as vault_ops
