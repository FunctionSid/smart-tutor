...
(:class:`smarttutor.capabilities.reading.capability.ReadingCapability`), which
...
from smarttutor.capabilities.reading.capability import (
    MATERIAL_ID_KEY,
    MODE_KEY,
    resolve_material_id,
)
from smarttutor.capabilities.reading.tools import READING_TOOL_NAMES
