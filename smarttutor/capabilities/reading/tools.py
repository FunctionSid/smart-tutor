...
def _guard(func):
    ...
    async def wrapper(self: _ReadingToolBase, **kwargs: Any) -> ToolResult:
        from smarttutor.reading import ReadingError
...
class MaterialOutlineTool(_ReadingToolBase):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from smarttutor.reading import render_outline
...
class SearchMaterialTool(_ReadingToolBase):
    ...
    @_guard
    async def execute(self, **kwargs: Any) -> ToolResult:
        from smarttutor.reading import search_material
...
class ReadMaterialTool(_ReadingToolBase):
    ...
    @_guard
    async def execute(self, **kwargs: Any) -> ToolResult:
        from smarttutor.reading import render_units
...
class ReaderGotoTool(_ReadingToolBase):
    ...
    @_guard
    async def execute(self, **kwargs: Any) -> ToolResult:
        from smarttutor.reading import verify_quote
...
class ReaderAnnotateTool(_ReadingToolBase):
    ...
    @_guard
    async def execute(self, **kwargs: Any) -> ToolResult:
        from smarttutor.reading import ANNOTATION_COLORS, Annotation, verify_quote
