...
from smarttutor.capabilities.explore_context import ExploreContextCapability
from smarttutor.capabilities.ima import ImaCapability
from smarttutor.capabilities.marginnote4 import MarginNoteCapability
from smarttutor.capabilities.mastery import MasteryLoopCapability
from smarttutor.capabilities.obsidian import ObsidianCapability
from smarttutor.capabilities.protocol import LoopCapability
from smarttutor.capabilities.reading import ReadingCapability
from smarttutor.capabilities.setup import SetupCapability
from smarttutor.capabilities.solve import SolveLoopCapability
from smarttutor.capabilities.subagent import SubagentCapability
from smarttutor.core.context import UnifiedContext
from smarttutor.core.entry_points import load_entry_point_group

logger = logging.getLogger(__name__)

LOOP_CAPABILITIES_GROUP = "smarttutor.loop_capabilities"
...
def discover_external_loop_capabilities() -> tuple[LoopCapability, ...]:
    """Load third-party loop capabilities from ``smarttutor.loop_capabilities``.
