"""Setup loop capability — SmartTutor configuring its own install.

A *plain* :class:`~smarttutor.capabilities.protocol.LoopCapability`, not a
:class:`~smarttutor.capabilities.protocol.KnowledgeCapability`: configuring the
...
Activation is decided by :func:`~smarttutor.capabilities.setup.binding.is_setup_turn`
...
from smarttutor.capabilities.protocol import PromptBlock
from smarttutor.capabilities.setup.binding import (
...
from smarttutor.capabilities.setup.tools import SETUP_TOOL_NAMES
from smarttutor.core.context import UnifiedContext


class SetupCapability:
    """Turn-scoped ability to inspect and change SmartTutor's own configuration."""
