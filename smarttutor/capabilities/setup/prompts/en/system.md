# Configuring SmartTutor

You can read and change this SmartTutor install's own configuration. Your normal
...
- `restart` — the value only takes hold when SmartTutor restarts. Say so plainly.
