...
from smarttutor.services.config import load_system_settings
from smarttutor.services.llm import get_token_limit_kwargs, supports_tools
from smarttutor.services.llm.openai_http_client import sanitize_invalid_ssl_env
from smarttutor.services.llm.reasoning_params import (
...
def _build_anthropic_adapter(config: LLMClientConfig, spec: Any) -> Any:
    from smarttutor.services.llm.provider_core import AnthropicProvider
...
def _build_codex_adapter(config: LLMClientConfig, spec: Any) -> Any:
    from smarttutor.services.codex_auth.constants import CODEX_DEFAULT_MODEL_ID
    from smarttutor.services.llm.provider_core import OpenAICodexProvider
...
def _build_copilot_adapter(config: LLMClientConfig, spec: Any) -> Any:
    from smarttutor.services.llm.provider_core import GitHubCopilotProvider
...
def _build_codebuddy_adapter(config: LLMClientConfig, spec: Any) -> Any:
    from smarttutor.services.llm.provider_core.codebuddy_http_provider import (
...
def _build_direct_openai_adapter(config: LLMClientConfig, spec: Any) -> Any:
    from smarttutor.services.llm.provider_core import OpenAICompatProvider
