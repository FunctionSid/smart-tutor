...
from smarttutor.core.agentic.tool_arg_guard import (
    missing_args_message,
    missing_required_args,
)
from smarttutor.core.context import UnifiedContext
from smarttutor.core.stream_bus import StreamBus
from smarttutor.core.tool_protocol import ToolLookup, provider_identity
...
async def _reject_if_args_missing(
    *,
    ...
    fill in. See :mod:`smarttutor.core.agentic.tool_arg_guard` for why the
