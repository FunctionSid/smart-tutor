...
class UsageTracker:
    ...
    * :meth:`add_estimated` — fall back to a coarse ``chars / 3.5`` estimate
    ...
    ``total_cost_usd`` via the pricing table in ``smarttutor.logging.stats``.
    """
    ...
    def add_usage(
        ...
        *,
        ...
        """Adapter for :class:`~smarttutor.agents.base_agent.BaseAgent`.
    ...
    def summary(self) -> dict[str, Any] | None:
        ...
        if self.model:
            ...
            from smarttutor.logging.stats.llm_stats import get_pricing
