...
class SmartTutorError(Exception):
    """Base class for all application errors in SmartTutor."""
...
class ConfigurationError(SmartTutorError):
    """Raised when there's a configuration-related error."""

    pass


class ValidationError(SmartTutorError):
    """Raised when input validation fails."""

    pass


class ServiceError(SmartTutorError):
