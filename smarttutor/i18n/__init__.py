...
* :mod:`~smarttutor.i18n.metadata_i18n` — static localized display copy for
  built-in capabilities and tools (used by the settings UI / API).
* :mod:`~smarttutor.i18n.status_i18n` — per-feature localized status-string
  lookup wired into the :class:`PromptManager`, used by capability pipelines
  to stream locale-aware progress messages.
"""

from smarttutor.i18n.metadata_i18n import (
    capability_description_i18n,
    localized_description,
    tool_description_i18n,
)
from smarttutor.i18n.status_i18n import StatusI18n
