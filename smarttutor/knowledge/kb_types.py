...
Kept in its own low-level module so both :mod:`smarttutor.knowledge.manager`
...
def supports_local_raw_files(entry: Any) -> bool:
    """Whether the KB owns a SmartTutor-managed local ``raw/`` directory.
    ...
    SmartTutor's raw-file upload and management API.
    """
