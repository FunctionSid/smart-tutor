...
class ProgressTracker:
    ...
    def _notify(self, progress: dict):
        ...
        from smarttutor.runtime.mode import is_server
        ...
        try:
            ...
            manager.update_kb_status(
                ...
                progress={
                    ...
                    "duplicate_count": progress.get("duplicate_count"),
    ...
    def update(
        ...
        try:
            ...
            fallback_logger = logging.getLogger("smarttutor.ProgressTracker")
            prefix = f"[{self.task_id}]" if self.task_id else ""
        ...
        if self.task_id:
            try:
                from smarttutor.api.utils.task_log_stream import get_task_stream_manager
