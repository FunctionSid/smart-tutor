...
from smarttutor.learning.models import InteractionStatus, PendingQuestion
...
from smarttutor.tools.mastery_tool import (
    MasteryAssessTool,
    MasteryBuildTool,
    MasteryGradeTool,
    MasteryLeaveTool,
...
def session_store(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("smarttutor.services.session.get_sqlite_session_store", lambda: store)
    return store
