...
_CONFIGURED = False
_MANAGED_ATTR = "_smarttutor_managed"
...
def configure_logging(force: bool = False) -> LoggingConfig:
    ...
    logging.getLogger("smarttutor").setLevel(logging.DEBUG)
    logging.getLogger("smarttutor").propagate = True
