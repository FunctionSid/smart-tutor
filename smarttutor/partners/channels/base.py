...
class BaseChannel(ABC):
    ...
    def media_dir(self, channel: str | None = None) -> Path:
        ...
        from smarttutor.partners.config.paths import get_media_dir, get_partner_media_dir
    ...
    async def transcribe_audio(self, file_path: str | Path) -> str:
        ...
        if not self.transcription_api_key:
            return ""
        try:
            from smarttutor.partners.transcription import GroqTranscriptionProvider
