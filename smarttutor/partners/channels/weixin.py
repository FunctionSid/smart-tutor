...
from smarttutor.partners.config.paths import get_runtime_subdir
from smarttutor.partners.config.schema import DeliveryOverrides
from smarttutor.partners.helpers import safe_filename, split_message
...
class WeixinChannel(BaseChannel):
    ...
    async def _send_text(
        ...
        client_id = f"smarttutor-{uuid.uuid4().hex[:12]}"
