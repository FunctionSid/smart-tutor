"""Neutral plugin discovery for SmartTutor.

External packages register under the ``smarttutor.plugins`` entry-point group.
...
from smarttutor.core.capability_protocol import BaseCapability
from smarttutor.core.entry_points import load_entry_point_group

logger = logging.getLogger(__name__)

ENTRY_POINT_GROUP = "smarttutor.plugins"
...
def discover_plugins() -> list[PluginManifest]:
    """Discover plugins registered via ``smarttutor.plugins`` entry points."""
