...
:mod:`smarttutor.reading.extract` knows how a format is cut into units, and the
...
class ReadingError(RuntimeError):
    ...
    layer returns it as a failed :class:`~smarttutor.core.tool_protocol.ToolResult`
