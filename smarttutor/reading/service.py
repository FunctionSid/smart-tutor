...
chat loop or the LLM; it takes a :class:`~smarttutor.reading.store.ReadingStore`
...
from smarttutor.reading.models import MaterialManifest, OutlineEntry, ReadingError
from smarttutor.reading.search import SearchResult, locate_quote, search_units
from smarttutor.reading.store import MAX_READ_CHARS, ReadingStore
...
def render_units(
    ...
    *,
    ...
    (``--- Page 12 ---``), so a model that has seen a SmartTutor attachment
