...
from smarttutor.capabilities.protocol import AGENT_OUTPUT, EVENT_METADATA
from smarttutor.core.context import UnifiedContext
from smarttutor.core.stream import StreamEvent, StreamEventType
from smarttutor.core.stream_bus import StreamBus, register_bus, unregister_bus
...
def completion_event_fields(context: UnifiedContext, cap_name: str) -> tuple[str, dict[str, Any]]:
    ...
    ``smarttutor.capabilities.protocol``).
