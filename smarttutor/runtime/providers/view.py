...
from smarttutor.core.tool_protocol import BaseTool, ToolLookup
from smarttutor.runtime.providers.allowlist import Allowlist
from smarttutor.runtime.providers.authorize import authorize_mcp_tools
from smarttutor.runtime.providers.scope import ToolScope
from smarttutor.runtime.registry.deferred_tools import (
    DeferredToolLoader,
...
async def _build(
    *,
    ...
    from smarttutor.services.mcp import get_mcp_manager, load_loaded_tools
...
def _cli_app_tools(scope: ToolScope) -> list[BaseTool]:
    ...
    if scope.exclusive_capability:
        return []
    try:
        from smarttutor.multi_user.tool_access import allowed_cli_apps, exec_override
        from smarttutor.services.cli_apps.provider import authorized_apps, build_app_tools
...
def _user_grant(scope: ToolScope) -> Allowlist:
    ...
    from smarttutor.multi_user.tool_access import allowed_mcp_tools
