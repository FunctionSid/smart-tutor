...
from smarttutor.core.tool_protocol import provider_identity as _provider_identity
...
class DeferredToolLoader:
    ...
    def _persist(self) -> None:
        try:
            from smarttutor.services.mcp.session_state import record_loaded_tools
