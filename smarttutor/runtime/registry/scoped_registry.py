...
Two things the process-global :class:`~smarttutor.runtime.registry.tool_registry.ToolRegistry`
...
from smarttutor.tools.prompting import compose_prompt_text
...
class ScopedToolRegistry:
    ...
    Satisfies :class:`~smarttutor.core.tool_protocol.ToolLookup`. Intentionally
