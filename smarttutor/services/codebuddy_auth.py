...
class CodeBuddyAuthService:
    ...
    async def logout(self) -> dict[str, Any]:
        """Disconnect SmartTutor from the CodeBuddy session on this host.
        ...
        # SmartTutor does not own this credential: it is the session the IDE
        ...
        from smarttutor.core.agentic.client import reset_agentic_client_pool
        from smarttutor.services.codebuddy_credentials import load_credentials
    ...
    async def _probe_local_login(self) -> bool:
        ...
        """
        from smarttutor.services.codebuddy_credentials import load_credentials, probe_account
