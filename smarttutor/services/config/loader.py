...
Unified configuration loading for all SmartTutor modules.
...
def parse_language(language: Any) -> str:
    ...
    from smarttutor.services.prompt.language import normalize_language
...
def get_agent_params(module_name: str) -> dict:
    ...
    from smarttutor.services.setup.init import DEFAULT_AGENTS_SETTINGS
