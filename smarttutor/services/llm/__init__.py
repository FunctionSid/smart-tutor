...
Unified LLM service for all SmartTutor modules.
...
Usage:
    ...
    from smarttutor.services.llm import complete, stream
    ...
    # Configuration
    from smarttutor.services.llm import get_llm_config, LLMConfig
    config = get_llm_config()

    # URL utilities for local LLM servers
    from smarttutor.services.llm import sanitize_url, is_local_llm_server
"""
...
def __getattr__(name: str):
    ...
    if name == "cloud_provider":
        return import_module("smarttutor.services.llm.cloud_provider")
    if name == "local_provider":
        return import_module("smarttutor.services.llm.local_provider")
