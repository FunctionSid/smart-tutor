...
Usage:
    from smarttutor.services.llm.capabilities import get_capability, supports_response_format
...
MODEL_OVERRIDES: dict[str, dict[str, object]] = {
    ...
    # Keep reasoning-model temperature behavior explicit and provider-safe.
    "gpt-5": {
...
def threads_session_id(binding: str | None) -> bool:
    """Whether *binding* expects ``smarttutor_session_id`` on each request."""
