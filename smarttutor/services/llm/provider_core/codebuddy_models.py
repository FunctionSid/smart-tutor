...
from smarttutor.services.codebuddy_credentials import FALLBACK_MODEL_CATALOG, cached_model_catalog
...
async def fetch_codebuddy_models(api_key: str | None = None) -> list[str]:
    ...
    if importlib.util.find_spec("codebuddy_agent_sdk") is not None:
        from smarttutor.services.llm.provider_core.codebuddy_provider import (
