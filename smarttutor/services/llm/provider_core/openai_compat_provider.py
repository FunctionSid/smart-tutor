...
from smarttutor.services.llm.capabilities import disable_response_format_at_runtime
from smarttutor.services.llm.exceptions import LLMConfigError
from smarttutor.services.llm.openai_http_client import openai_client_kwargs
...
from smarttutor.services.llm.usage_frame import token_counts
from smarttutor.services.provider_registry import model_overrides_for

if TYPE_CHECKING:
    from smarttutor.services.provider_registry import ProviderSpec
...
_DEFAULT_OPENROUTER_HEADERS = {
    "HTTP-Referer": "https://smart-tutor.local",
    "X-OpenRouter-Title": "SmartTutor",
}
