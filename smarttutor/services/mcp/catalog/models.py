...
:class:`~smarttutor.services.mcp.config.MCPServerConfig`, the only server shape
the rest of SmartTutor understands.
...
:mod:`smarttutor.services.mcp.secrets` resolves in memory at connect time. That
...
from smarttutor.services.mcp.secrets import secret_reference
