...
(:mod:`smarttutor.services.mcp.config`). This module is the parallel store for
...
:mod:`smarttutor.services.mcp.secrets` mean anything.
...
def user_mcp_path(owner_id: str) -> Path:
    from smarttutor.multi_user.paths import SYSTEM_ROOT
