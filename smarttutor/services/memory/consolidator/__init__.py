...
* :class:`ConsolidateResult`, :data:`OnEvent` — legacy types preserved
  for :mod:`smarttutor.services.memory.store`.
...
from smarttutor.services.memory.consolidator.guards import _filter_banned, _has_banned
from smarttutor.services.memory.consolidator.modes import (
    consolidate_l2,
    consolidate_l3,
    run_audit,
    run_dedup,
...
from smarttutor.services.memory.consolidator.parse import _parse_ops_response
