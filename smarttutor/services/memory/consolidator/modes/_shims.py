"""Legacy public-API shims for :mod:`smarttutor.services.memory.store`.
...
from smarttutor.services.memory.consolidator.modes.update import (
    UpdateResult,
    run_update,
)
from smarttutor.services.memory.document import parse, serialize
from smarttutor.services.memory.ops import ApplyReport, Op
