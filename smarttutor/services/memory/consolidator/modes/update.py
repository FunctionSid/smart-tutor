...
from smarttutor.services.memory.consolidator.chunker import (
    chunk_with_boundary,
)
from smarttutor.services.memory.consolidator.meta import (
    load_l2_meta,
    load_l3_meta,
    save_l2_meta,
    save_l3_meta,
...
from smarttutor.services.memory.consolidator.references import (
    ExtractedFact,
    refs_in_span_l2,
    refs_in_span_l3,
...
from smarttutor.services.memory.document import Document, Entry, serialize
from smarttutor.services.memory.ops import AddOp
from smarttutor.services.memory.ops import apply as apply_ops
    ...
    *,
    ...
    if not new_entities:
        ...
        if settings.merge.auto_after_update:
            from smarttutor.services.memory.consolidator.modes.merge import run_merge
    ...
    if settings.dedup.auto_after_update and facts_added > 0:
        ...
        from smarttutor.services.memory.consolidator.modes.dedup import run_dedup
