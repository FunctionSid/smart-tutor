...
from smarttutor.services.memory import consolidator, paths, trace
from smarttutor.services.memory.consolidator import ConsolidateResult, OnEvent
from smarttutor.services.memory.document import Document, parse, serialize
from smarttutor.services.memory.ops import AddOp, ApplyReport, EditOp, OpResult
from smarttutor.services.memory.ops import apply as ops_apply
...
_NO_MEMORY = (
    "(No memory available — interact with SmartTutor and update from the Memory page to build one.)"
)
...
class MemoryStore:
    ...
    async def apply_ops_payload(
        ...
        """
        from smarttutor.services.memory.consolidator import _parse_ops_response
