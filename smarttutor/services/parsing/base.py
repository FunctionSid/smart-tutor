...
stage. An engine turns bytes/path into a :class:`~smarttutor.services.parsing.types.ParsedDocument`
...
class Parser(Protocol):
    ...
    def parse(
        ...
        *,
        ...
        workdir via :func:`smarttutor.services.parsing.cache.load_ir` and writes
