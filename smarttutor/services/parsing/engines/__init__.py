...
Each engine implements the :class:`~smarttutor.services.parsing.base.Parser`
contract and is selected by name through :mod:`smarttutor.services.parsing.engines.factory`.
