...
Each partner runs as a set of asyncio tasks within the SmartTutor server
...
from smarttutor.partners.config.paths import (
    get_data_dir,
    get_partner_dir,
...
class PartnerManager:
    ...
    async def _outbound_router(self, partner_id: str, bus: Any, instance: PartnerInstance) -> None:
        ...
        try:
            from smarttutor.events.event_bus import Event, EventType, get_event_bus
            from smarttutor.partners.bus.events import OutboundMessage as _OMsg
