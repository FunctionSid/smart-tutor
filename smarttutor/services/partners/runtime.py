...
from smarttutor.multi_user.paths import get_current_path_service, user_context
from smarttutor.partners.bus.events import InboundMessage, OutboundMessage
...
from smarttutor.partners.helpers import detect_image_mime
from smarttutor.services.partners.commands import PartnerCommandHandler
from smarttutor.services.partners.interaction import (
    build_partner_turn_context,
    partner_turn_context,
    personal_actor_id,
)
from smarttutor.services.partners.scope import partner_user
from smarttutor.services.partners.sessions import PartnerSessionStore
from smarttutor.services.partners.workspace import ensure_partner_workspace, read_soul
    ...
    def _build_context(
        ...
        *,
        ...
        metadata: dict[str, Any] = {
            ...
            # Swaps the system prompt's product identity ("You are SmartTutor")
