...
from smarttutor.multi_user.paths import (
    ensure_scope_workspace,
    get_admin_path_service,
    get_path_service_for_scope,
)
from smarttutor.services.partners.scope import partner_scope
...
def _skill_source_dir(skill_name: str) -> Path:
    ...
    """
    from smarttutor.multi_user.context import get_current_user
    from smarttutor.services.skill.service import BUILTIN_SKILLS_ROOT
