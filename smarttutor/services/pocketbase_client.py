...
Usage:
    from smarttutor.services.pocketbase_client import get_pb_client, is_pocketbase_enabled
...
from smarttutor.services.config import load_integrations_settings
