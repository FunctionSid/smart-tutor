...
def provider_uses_embedding_versions(provider: Optional[str]) -> bool:
    ...
    Today only the LlamaIndex pipeline uses SmartTutor's active embedding
...
def list_pipelines() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "name": "GraphRAG",
            "description": "Local knowledge-graph retrieval (global/local/drift/basic). Needs `pip install 'smarttutor[graphrag]'`; indexing is LLM-heavy.",
        ...
        },
        {
            ...
            "name": "LightRAG",
            "description": "Graph + vector retrieval with multimodal parsing (naive/local/global/hybrid/mix). Needs `pip install 'smarttutor[rag-lightrag]'`; indexing is LLM-heavy.",
