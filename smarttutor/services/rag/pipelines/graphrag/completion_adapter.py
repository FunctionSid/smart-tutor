...
def _get_adapter_class() -> type:
    ...
    with _CAPABILITY_LOCK:
        ...
        class SmartTutorLiteLLMCompletion(LiteLLMCompletion):
        ...
        _ADAPTER_CLASS = SmartTutorLiteLLMCompletion
        return _ADAPTER_CLASS


def register_completion_adapter() -> None:
    """Register SmartTutor's completion type through GraphRAG's public factory API."""
