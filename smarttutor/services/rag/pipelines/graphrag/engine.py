...
used — SmartTutor runs fine without the optional dependency installed.
"""
...
EMBEDDING_PROBE_TEXT = "SmartTutor GraphRAG embedding compatibility test"
...
async def _probe_completion_model_impl(llm_cfg: Any) -> None:
    """Probe a resolved SmartTutor model through the GraphRAG adapter."""
