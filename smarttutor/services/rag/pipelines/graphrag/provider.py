"""Resolve SmartTutor model bindings at the GraphRAG/LiteLLM boundary."""

from __future__ import annotations

from typing import Any

from smarttutor.services.llm.reasoning_params import build_openai_compatible_reasoning_kwargs
from smarttutor.services.provider_registry import find_by_name, strip_provider_prefix

from .errors import GraphRagUnsupportedProviderError

COMPLETION_TYPE = "smarttutor_litellm"
...
def resolve_completion_provider(llm_cfg: Any) -> str:
    """Map a resolved SmartTutor provider to the narrow LiteLLM transport GraphRAG needs."""
    ...
    if spec.backend == "openai_compat":
        ...
        # Other SmartTutor OpenAI-compatible profiles already expose an OpenAI
...
def resolve_persisted_completion_provider(model_config: Any) -> str:
    """Recover a provider for old SmartTutor GraphRAG settings without rewriting them."""
