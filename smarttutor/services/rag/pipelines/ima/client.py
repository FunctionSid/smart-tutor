...
A method table over the calls SmartTutor needs, with the wire mechanics delegated
to :class:`~smarttutor.services.rag.pipelines.ima.transport.ImaTransport`, the
