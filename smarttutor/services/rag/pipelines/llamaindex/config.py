"""Configuration helpers for SmartTutor's LlamaIndex RAG pipeline."""
...
def retrieval_config_from_env() -> RetrievalConfig:
    ...
    return RetrievalConfig(
        profile=normalize_retrieval_profile(
            os.getenv("SMARTTUTOR_RAG_RETRIEVAL_PROFILE") or os.getenv("RAG_RETRIEVAL_PROFILE")
        )
    )
...
def _load_runtime_settings() -> dict:
    ...
    from smarttutor.services.config import load_llamaindex_settings
