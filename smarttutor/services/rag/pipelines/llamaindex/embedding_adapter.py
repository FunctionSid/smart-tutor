"""LlamaIndex embedding adapter backed by SmartTutor's embedding service."""
...
from smarttutor.services.embedding import EmbeddingConfig, get_embedding_client, get_embedding_config
from smarttutor.services.embedding.validation import validate_embedding_batch
...
class CustomEmbedding(BaseEmbedding):
    """Custom LlamaIndex embedding adapter for SmartTutor embedding providers."""
...
def configure_llamaindex_settings(logger=None) -> None:
    """Configure LlamaIndex globals for SmartTutor's current embedding config."""
