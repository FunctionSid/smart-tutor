"""Turn-scoped SmartTutor wrappers for PageIndex Cloud and OSS SDK tools."""
...
from smarttutor.core.tool_protocol import BaseTool, ToolDefinition, ToolLookup, ToolResult
...
def pageindex_sources_from_text(
    ...
    *,
    ...
    """Normalize real PageIndex page reads into SmartTutor source rows."""
    try:
