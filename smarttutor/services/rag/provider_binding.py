...
SmartTutor owns the knowledge-base lifecycle and stores the authoritative
...
from smarttutor.services.rag.factory import DEFAULT_PROVIDER, normalize_provider_name
...
def resolve_bound_provider(kb_base_dir: str | Path, kb_name: str | None) -> str:
    """Resolve the provider SmartTutor has bound to a KB.
