...
def _ensure_essential_settings(path_service) -> None:
    ...
    try:
        from smarttutor.services.config import ensure_runtime_settings_files
...
def _seed_default_personas() -> None:
    ...
    try:
        ...
        from smarttutor.services.persona.service import PersonaService
...
def get_backend_port(project_root: Path | None = None) -> int:
    ...
    """
    try:
        from smarttutor.services.config.launch_settings import load_launch_settings
