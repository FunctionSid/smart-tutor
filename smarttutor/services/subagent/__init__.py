...
SmartTutor runs on the same machine as the user's configured agent CLIs — Claude
...
from smarttutor.services.subagent.partner import PARTNER_BACKEND_KIND
from smarttutor.services.subagent.registry import detect_all, get_backend, list_backend_kinds
