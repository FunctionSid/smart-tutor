...
from smarttutor.services.subagent.types import ConsultResult, DetectResult, SubagentEvent
...
class SubagentBackend(ABC):
    ...
    async def consult(
        ...
        *,
        ...
        subagent keeps context across SmartTutor's successive questions); the
