...
TTS_ADAPTERS: dict[str, BaseTTSAdapter] = {
    ...
    "global_edge_tts": GlobalEdgeTTSTTSAdapter(),
    "global_piper": GlobalPiperTTSAdapter(),
    "global_pyttsx3": GlobalPyttsx3TTSAdapter(),
    "global_gtts": GlobalGTTSTTSAdapter(),
    "windows_system_speech": WindowsSystemSpeechTTSAdapter(),
}

STT_ADAPTERS: dict[str, BaseSTTAdapter] = {
    "openai_compat": OpenAICompatSTTAdapter(),
    "global_faster_whisper": GlobalFasterWhisperSTTAdapter(),
}
