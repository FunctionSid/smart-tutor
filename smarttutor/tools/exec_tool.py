...
runs through the :mod:`smarttutor.services.sandbox` layer rather than a raw
...
# NOTE: ``smarttutor.services.sandbox`` is imported lazily inside ``execute``
# (not at module top). This tool is loaded by ``smarttutor.tools.builtin``,
