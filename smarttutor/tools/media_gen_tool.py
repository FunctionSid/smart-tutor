...
def _write_media(
    ...
    *,
    ...
    from smarttutor.services.sandbox.artifacts import collect_public_artifacts
...
def _artifact_result(
    ...
    from smarttutor.services.sandbox.artifacts import render_artifacts_for_tool
...
class ImagegenTool(BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from smarttutor.services.imagegen import GenerationProviderError, generate_image
...
class VideogenTool(BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from smarttutor.services.videogen import GenerationProviderError, generate_video
