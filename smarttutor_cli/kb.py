...
from smarttutor.services.rag.factory import DEFAULT_PROVIDER
...
def register(app: typer.Typer) -> None:
    ...
    def kb_create(
        ...
        from smarttutor.knowledge.initializer import initialize_knowledge_base
    ...
    def kb_add(
        ...
        from smarttutor.knowledge.add_documents import add_documents
