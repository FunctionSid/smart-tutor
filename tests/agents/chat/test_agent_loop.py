...
from smarttutor.agents.chat import agent_loop as agent_loop_mod
from smarttutor.agents.chat.agent_loop import InlineThinkFilter
from smarttutor.agents.chat.agentic_pipeline import AgenticChatPipeline
from smarttutor.capabilities.explore_context import explorer as explorer_mod
from smarttutor.capabilities.mastery import MASTERY_TOOL_NAMES
...
from smarttutor.core.tool_protocol import ToolResult
from smarttutor.services.llm import LLMProviderTransportError
...
def _fake_llm_config(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr(
        "smarttutor.agents.chat.agentic_pipeline.get_llm_config",
...
def test_compose_enabled_tools_injects_rag_when_kb_selected(
    ...
    monkeypatch.setattr(
        "smarttutor.services.notebook.get_notebook_manager",
