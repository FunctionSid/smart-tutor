...
from smarttutor.agents.chat.agent_loop import MAX_SETTLEMENT_ROUNDS
from smarttutor.agents.chat.agentic_pipeline import AgenticChatPipeline
from smarttutor.agents.chat.context_budget import (
    LLMRequestSnapshot,
    build_context_budget,
    count_conversation_tokens,
    resolve_window_info,
)
from smarttutor.capabilities import PromptBlock
