...
def test_summarize_agent_stores_extra_headers(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "smarttutor.agents.notebook.summarize_agent.get_llm_config",
        lambda: cfg,
    )

    from smarttutor.agents.notebook.summarize_agent import NotebookSummarizeAgent
...
async def test_summarize_agent_forwards_extra_headers(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "smarttutor.agents.notebook.summarize_agent.llm_stream",
        _fake_llm_stream,
    )
