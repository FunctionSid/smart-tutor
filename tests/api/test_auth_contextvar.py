...
def test_require_auth_is_async_def() -> None:
    from smarttutor.api.routers.auth import require_admin, require_auth
...
def test_install_current_user_maps_none_to_local_admin() -> None:
    ...
    from smarttutor.api.routers.auth import _install_current_user
    from smarttutor.multi_user.context import get_current_user_or_none, reset_current_user
...
def test_install_current_user_maps_payload_to_scoped_user() -> None:
    ...
    from smarttutor.api.routers.auth import _install_current_user
    from smarttutor.multi_user.context import get_current_user_or_none, reset_current_user
    from smarttutor.services.auth import TokenPayload
...
def test_local_admin_token_payload_matches_local_admin_user() -> None:
    ...
    from smarttutor.api.routers.auth import _local_admin_token_payload
    from smarttutor.multi_user.models import LOCAL_ADMIN_ID, LOCAL_ADMIN_USERNAME
...
def test_path_service_resolves_per_user_workspace_through_dependency(monkeypatch, tmp_path) -> None:
    ...
    admin fallback."""
    from smarttutor.api.routers import auth as auth_router
    from smarttutor.multi_user import paths as mu_paths
    from smarttutor.services.auth import TokenPayload
