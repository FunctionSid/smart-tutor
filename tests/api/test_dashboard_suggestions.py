...
from smarttutor.api.routers import dashboard
...
def test_suggestions_is_not_swallowed_by_the_entry_route(
    ...
    import smarttutor.services.suggestions as service
...
def test_refresh_returns_a_fresh_set(client: TestClient, monkeypatch: pytest.MonkeyPatch) -> None:
    import smarttutor.services.suggestions as service
    from smarttutor.services.suggestions import Suggestion, SuggestionSet
