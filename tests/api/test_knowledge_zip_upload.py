...
from smarttutor.api.routers.knowledge import _save_uploaded_files
...
def _disable_pocketbase(monkeypatch):
    monkeypatch.setattr("smarttutor.services.pocketbase_client.is_pocketbase_enabled", lambda: False)
