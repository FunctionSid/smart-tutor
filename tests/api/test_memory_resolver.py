...
memory_router = importlib.import_module("smarttutor.api.routers.memory").router
paths_mod = importlib.import_module("smarttutor.services.memory.paths")
document_mod = importlib.import_module("smarttutor.services.memory.document")
