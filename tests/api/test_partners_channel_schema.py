...
from smarttutor.api.routers._partners_channel_schema import (
    all_channel_schemas,
...
from smarttutor.api.routers.partners import _validate_channels_payload
...
class TestResolveConfigModel:
    def test_telegram_pairs_with_telegram_config(self) -> None:
        from smarttutor.partners.channels.telegram import TelegramChannel, TelegramConfig

        assert resolve_config_model(TelegramChannel) is TelegramConfig

    def test_slack_pairs_with_slack_config(self) -> None:
        from smarttutor.partners.channels.slack import SlackChannel, SlackConfig

        assert resolve_config_model(SlackChannel) is SlackConfig

    def test_discord_pairs_with_discord_config(self) -> None:
        from smarttutor.partners.channels.discord import DiscordChannel, DiscordConfig
...
class TestChannelSchemaPayload:
    def test_telegram_payload_shape(self) -> None:
        from smarttutor.partners.channels.telegram import TelegramChannel
    ...
    def test_slack_dm_subtree_inlined(self) -> None:
        from smarttutor.partners.channels.slack import SlackChannel
...
class TestEndpoint:
    ...
    def client(self) -> TestClient:
        ...
        from smarttutor.api.routers import partners as partners_router
