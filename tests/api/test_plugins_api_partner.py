...
def _client_with_fake_partner(monkeypatch):
    ...
    mgr = FakeMgr()
    partners_router_mod = importlib.import_module("smarttutor.api.routers.partners")
    plugins_router_mod = importlib.import_module("smarttutor.api.routers.plugins_api")
