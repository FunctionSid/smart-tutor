...
from smarttutor.api.routers import space_cli_apps
...
def test_a_failed_install_answers_with_its_log(
    ...
    from smarttutor.services.cli_apps.installer import InstallOutcome
    ...
    monkeypatch.setattr("smarttutor.services.cli_apps.installer.install_app", _fail)
