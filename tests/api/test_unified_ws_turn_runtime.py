...
from smarttutor.services.session.turn_runtime import TurnRuntimeManager
...
async def test_turn_runtime_replays_events_and_materializes_messages(
    ...
    monkeypatch.setattr("smarttutor.services.llm.config.get_llm_config", lambda: SimpleNamespace())
    monkeypatch.setattr(
        "smarttutor.services.session.context_builder.ContextBuilder", FakeContextBuilder
    )
    monkeypatch.setattr("smarttutor.runtime.orchestrator.ChatOrchestrator", FakeOrchestrator)
    monkeypatch.setattr(
        "smarttutor.book.context.build_book_context",
    ...
    monkeypatch.setattr(
        "smarttutor.services.memory.get_memory_store",
    ...
    monkeypatch.setattr(
        "smarttutor.services.skill.get_skill_service",
        _fake_skill_service,
    )
    monkeypatch.setattr(
        "smarttutor.services.persona.get_persona_service",
...
async def test_turn_runtime_persists_llm_selection_in_turn_snapshot(
    ...
    monkeypatch.setattr(
        "smarttutor.services.config.get_model_catalog_service",
    ...
    monkeypatch.setattr(
        "smarttutor.services.model_selection.runtime.reset_llm_selection",
    ...
    monkeypatch.setattr("smarttutor.services.skill.get_skill_service", _fake_skill_service)
    monkeypatch.setattr("smarttutor.services.persona.get_persona_service", _fake_persona_service)
