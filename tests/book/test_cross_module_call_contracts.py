...
def test_math_animator_request_config_fields() -> None:
    ...
    pytest.importorskip("smarttutor.agents.math_animator.pipeline")
    from smarttutor.agents.math_animator.pipeline import MathAnimatorRequestConfig
...
def test_the_book_prompt_loader_contract() -> None:
    ...
    from smarttutor.book.blocks._prompts import get_book_prompt, load_book_prompts
