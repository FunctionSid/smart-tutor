...
from smarttutor.book.engine import BookEngine
from smarttutor.book.models import Block, BlockStatus, BlockType, Page, PageStatus
...
def _engine(page: Page) -> BookEngine:
    ...
    from smarttutor.book.compiler import BookCompiler, CompilerOptions
