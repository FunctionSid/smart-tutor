...
from smarttutor.book.kb_health import (
    FINGERPRINT_SCHEME,
    mark_drift_on_book,
    refresh_book_fingerprints,
)
from smarttutor.book.models import (
    Block,
    BlockStatus,
    BlockType,
    Book,
...
import smarttutor.book.storage as storage_module
...
def test_force_refresh_clears_drift_with_pages_still_stale(tmp_path: Path, monkeypatch) -> None:
    ...
    from smarttutor.book.kb_health import refresh_book_fingerprints
