...
from smarttutor.capabilities import any_exclusive_capability_active
from smarttutor.capabilities.ima import IMA_TOOL_NAMES, ImaCapability
from smarttutor.capabilities.ima import binding as ima_binding
from smarttutor.capabilities.ima import tools as ima_tools
from smarttutor.capabilities.ima.binding import ImaBinding, select_binding
from smarttutor.capabilities.ima.tools import (
    BINDINGS_KWARG,
    ImaAddUrlTool,
    ImaListTool,
    ImaNoteSearchTool,
...
from smarttutor.services.rag.pipelines.ima.config import ImaNotConfiguredError
from smarttutor.services.rag.pipelines.ima.envelope import ImaAuthError
from smarttutor.services.rag.pipelines.ima.media import ImaMediaContent
from smarttutor.services.rag.pipelines.ima.models import (
    ImaDocument,
    ImaFolder,
    ImaImportedUrl,
    ImaKnowledgePage,
...
class TestBinding:
    def test_only_ima_knowledge_bases_bind(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "smarttutor.multi_user.knowledge_access.resolve_kb_metadata",
            metadata.get,
            raising=False,
        )
    ...
    def test_resolution_is_cached_on_the_turn(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "smarttutor.multi_user.knowledge_access.resolve_kb_metadata", resolve, raising=False
        )
