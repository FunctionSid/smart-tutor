...
from smarttutor.capabilities.mastery.capability import MasteryPathCapability
from smarttutor.capabilities.mastery.loop import MasteryLoopCapability
...
async def test_status_on_unknown_path_creates_nothing(tmp_path, monkeypatch):
    ...
    """
    from smarttutor.capabilities.mastery.tools import MasteryStatusTool
...
async def test_recording_tools_refuse_an_unbuilt_path_without_creating_it(tmp_path, monkeypatch):
    ...
    from smarttutor.capabilities.mastery.tools import (
        MasteryAssessTool,
        MasteryGradeTool,
        MasteryQuizTool,
    )
