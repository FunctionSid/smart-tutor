...
def test_gemini_embedding_fallback_prefers_stable_embedding2() -> None:
    from smarttutor_cli.init_wizard import EMBEDDING_FALLBACK_MODELS
...
def test_embedding_setup_preserves_saved_endpoint_for_same_provider() -> None:
    ...
    from smarttutor_cli.init_cmd import _embedding_default_endpoint
...
def test_gemini_native_embedding_endpoint_derives_native_models_url() -> None:
    from smarttutor_cli.init_wizard import _derive_embedding_models_url
...
def test_fetch_gemini_models_uses_auth_matching_endpoint_host(monkeypatch) -> None:
    from smarttutor_cli import init_wizard
...
def test_review_panel_redacts_embedding_endpoint_query_key() -> None:
    from smarttutor_cli.init_wizard import EmbeddingChoice, render_review_panel
...
def test_wizard_search_providers_match_the_backend_spec_table() -> None:
    ...
    ``smarttutor_cli.init_wizard.SEARCH_PROVIDERS`` carries what only the wizard
    ...
    """
    from smarttutor.services.config.provider_runtime import SEARCH_PROVIDERS as BACKEND
    from smarttutor_cli.init_wizard import SEARCH_PROVIDERS as WIZARD
