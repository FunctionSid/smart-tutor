"""CLI smoke tests for ``smarttutor notebook`` commands."""
...
def _patch_facade(monkeypatch) -> None:
    """Patch SmartTutorApp methods to use the shared fake manager."""
    ...
    from smarttutor.app import facade

    monkeypatch.setattr(facade.SmartTutorApp, "create_notebook", _create_notebook)
    monkeypatch.setattr(facade.SmartTutorApp, "get_notebook", _get_notebook)
    monkeypatch.setattr(facade.SmartTutorApp, "add_record", _add_record)
    monkeypatch.setattr(facade.SmartTutorApp, "update_record", _update_record)
    monkeypatch.setattr(facade.SmartTutorApp, "remove_record", _remove_record)
