...
from smarttutor_cli import provider_cmd
from smarttutor_cli.main import app

ROOT = Path(__file__).resolve().parents[2]
PROVIDER_CMD = (ROOT / "smarttutor_cli" / "provider_cmd.py").read_text(encoding="utf-8")
CLI_README = (ROOT / "smarttutor_cli" / "README.md").read_text(encoding="utf-8")
