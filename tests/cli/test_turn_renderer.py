...
The chat agent loop (smarttutor/agents/chat/agent_loop.py) streams every
...
from smarttutor.app import TurnRequest
from smarttutor_cli import common as cli_common
from smarttutor_cli.common import _resolve_answer
...
def _install_fake_runtime(
    ...
    *,
    ...
    monkeypatch.setattr("smarttutor.app.facade.SmartTutorApp.submit_user_reply", _submit_user_reply)
