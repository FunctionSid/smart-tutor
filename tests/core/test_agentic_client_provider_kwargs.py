...
from smarttutor.core.agentic import client as agentic_client
from smarttutor.core.agentic.client import (
...
from smarttutor.services.llm.provider_core.base import LLMResponse, ToolCallRequest
...
def test_build_openai_client_routes_anthropic_backend_through_adapter(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "smarttutor.services.llm.provider_core.AnthropicProvider",
        FakeProvider,
    )
...
def test_build_openai_client_routes_oauth_backend_through_adapter(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "smarttutor.services.llm.provider_core.OpenAICodexProvider",
        FakeProvider,
    )
...
def test_build_openai_client_routes_github_copilot_backend_through_adapter(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "smarttutor.services.llm.provider_core.GitHubCopilotProvider",
        FakeProvider,
    )
...
def test_build_openai_client_routes_codebuddy_backend_through_adapter(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "smarttutor.services.llm.provider_core.codebuddy_http_provider.CodeBuddyHTTPProvider",
        FakeProvider,
    )
...
async def test_direct_openai_gpt5_agentic_tools_use_provider_adapter(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "smarttutor.services.llm.provider_core.openai_compat_provider.AsyncOpenAI",
        FakeOpenAI,
    )
