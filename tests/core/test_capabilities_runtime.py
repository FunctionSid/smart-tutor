...
from smarttutor.agents.chat.capability import ChatCapability
from smarttutor.agents.question.capability import DeepQuestionCapability
from smarttutor.agents.research.capability import DeepResearchCapability
from smarttutor.agents.visualize.capability import VisualizeCapability
import smarttutor.agents.visualize.pipeline as visualize_pipeline
from smarttutor.capabilities.solve.capability import DeepSolveCapability
...
from smarttutor.runtime.bootstrap.builtin_capabilities import BUILTIN_CAPABILITY_CLASSES
...
async def test_chat_capability_streams_content_and_geogebra_context(
    ...
    monkeypatch.setattr("smarttutor.agents.chat.capability.AgenticChatPipeline", FakePipeline)
...
async def test_deep_solve_capability_runs_chat_loop_in_solve_mode(
    ...
    monkeypatch.setattr("smarttutor.capabilities.solve.capability.AgenticChatPipeline", FakePipeline)
...
async def test_deep_question_capability_uses_single_call_followup_agent(
    ...
    _install_module(
        monkeypatch,
        "smarttutor.agents.question.coordinator",
        AgentCoordinator=FakeCoordinator,
    )
    _install_module(
        monkeypatch,
        "smarttutor.agents.question.agents.followup_agent",
        FollowupAgent=FakeFollowupAgent,
    )
    _install_module(
        monkeypatch,
        "smarttutor.services.llm.config",
...
async def test_deep_research_capability_delegates_to_pipeline(
    ...
    """
    import smarttutor.agents.research.capability as deep_research_mod
    import smarttutor.agents.research.request_config  # noqa: F401
