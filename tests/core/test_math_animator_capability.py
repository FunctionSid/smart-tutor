...
from smarttutor.agents.math_animator.capability import MathAnimatorCapability
...
async def test_math_animator_capability_emits_summary_and_result(
    ...
    monkeypatch.setattr(
        "smarttutor.agents.math_animator.capability.importlib.util.find_spec",
    ...
    monkeypatch.setattr(
        "smarttutor.agents.math_animator.pipeline.MathAnimatorPipeline", FakePipeline
    )
    monkeypatch.setattr(
