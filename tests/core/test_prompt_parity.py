...
AGENTS_DIR = PROJECT_ROOT / "smarttutor" / "agents"
# Modules that live outside smarttutor/agents/ but still own prompts.
EXTRA_PROMPT_MODULE_DIRS = (
    PROJECT_ROOT / "smarttutor" / "book",
    PROJECT_ROOT / "smarttutor" / "co_writer",
)
