...
from smarttutor.knowledge.kb_types import CONNECTED_KB_TYPES, IMA_KB_TYPE
...
def test_has_no_local_document_root(tmp_path) -> None:
    ...
    from smarttutor.knowledge.manifest import document_root
...
def test_documents_are_non_enumerable_when_the_library_is_unreachable(
    ...
    from smarttutor.knowledge.manifest import UNAVAILABLE_REMOTE, build_manifest
...
def test_a_reachable_library_enumerates_its_documents(tmp_path, monkeypatch) -> None:
    ...
    from smarttutor.knowledge import manifest as manifest_module
    from smarttutor.knowledge.manifest import build_manifest
