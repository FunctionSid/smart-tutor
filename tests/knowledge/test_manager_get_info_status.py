...
def _patch_active_embedding(
    ...
    from smarttutor.knowledge import manager as manager_module
    from smarttutor.services.rag import embedding_signature
...
def test_get_info_does_not_reparse_docstore_on_repeat_calls(
    ...
    from smarttutor.services.rag import index_probe as probe_module
