...
from smarttutor.api.utils.task_log_stream import (
...
def test_capture_task_logs_keeps_user_stages_and_drops_runtime_noise():
    ...
    loggers = {
        ...
        for name in (
            "root",
            "asyncio",
            "smarttutor.knowledge.progress_tracker",
            "smarttutor.services.rag.pipelines.pageindex.pipeline",
        )
    }
    ...
    try:
        ...
        with capture_task_logs("task-curated"):
            ...
            loggers["smarttutor.knowledge.progress_tracker"].info("duplicate progress")
            loggers["smarttutor.services.rag.pipelines.pageindex.pipeline"].info(
