...
from smarttutor.multi_user import partner_access
from smarttutor.multi_user.grants import empty_grant, normalize_grant
...
def _patch_manager(monkeypatch, partners: list[dict]) -> None:
    import smarttutor.services.partners as pkg
...
def test_admin_partner_summary_is_identity_only(monkeypatch):
    from smarttutor.multi_user import router
