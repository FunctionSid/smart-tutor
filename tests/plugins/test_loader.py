"""Tests for the neutral smarttutor.plugins.loader entry-point discovery."""
...
import smarttutor.core.entry_points as ep_module
...
def test_discover_plugins_from_capability_class(monkeypatch):
    from smarttutor.plugins import loader

    def fake_entry_points(*, group: str):
        assert group == "smarttutor.plugins"
...
def test_load_plugin_capability_skips_tool_entry():
    from smarttutor.plugins.loader import PluginManifest, load_plugin_capability
...
def test_discover_from_manifest_factory(monkeypatch):
    from smarttutor.plugins import loader
    from smarttutor.plugins.loader import PluginManifest
...
def test_capability_registry_loads_plugins(monkeypatch):
    from smarttutor.plugins import loader
    from smarttutor.runtime.registry import capability_registry as cr
