...
def _patch_event_bus():
    ...
    with patch("smarttutor.runtime.orchestrator.get_event_bus", return_value=mock_bus):
        yield
    from smarttutor.events.event_bus import EventBus
...
class TestCompletionEventFields:
    def test_reads_agent_output_and_declared_event_metadata(self) -> None:
        from smarttutor.runtime.orchestrator import completion_event_fields
