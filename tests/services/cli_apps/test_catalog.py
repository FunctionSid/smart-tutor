...
from smarttutor.services.cli_apps import catalog as catalog_module
from smarttutor.services.cli_apps import load_catalog, search_catalog
from smarttutor.services.cli_apps.catalog import (
    CATALOG_PATH,
    catalog_pin,
    category_counts,
    get_entry,
