...
from smarttutor.services.cli_apps.paths import abi_stamp, bin_dir, runtime_dir
from smarttutor.services.cli_apps.provider import (
    CliAppTool,
    authorized_apps,
    build_app_tools,
)
from smarttutor.services.cli_apps.state import InstalledApp, record_install, set_app_enabled
...
def test_a_string_of_args_is_split_without_shell_semantics() -> None:
    ...
    import smarttutor.services.cli_apps.provider as provider_module
...
def test_a_file_the_app_wrote_is_surfaced_as_a_link(
    ...
    from smarttutor.services.sandbox.artifacts import SandboxArtifact

    monkeypatch.setattr(
        "smarttutor.services.sandbox.artifacts.collect_public_artifacts",
        lambda _workdir: [
            SandboxArtifact(
                filename="out.png",
...
def test_the_apps_own_bin_comes_first_and_the_host_path_is_not_discarded(
    ...
    """
    from smarttutor.services.cli_apps.runner import _env_for
...
def test_an_abi_mismatch_refuses_with_an_actionable_message(monkeypatch) -> None:
    ...
    from smarttutor.services.cli_apps.runner import run_app
