...
from smarttutor.services.codex_auth import service as service_module
from smarttutor.services.codex_auth.contracts import (
    CatalogSnapshot,
    CodexAuthError,
    CodexCredentials,
    CodexModel,
)
from smarttutor.services.codex_auth.oauth import OAuthCallbackResult
from smarttutor.services.codex_auth.service import (
    CODEX_PROFILE_ID,
    MANAGED_BY,
    CodexOAuthService,
    codex_model_id,
...
from smarttutor.services.codex_auth.storage import CodexCredentialStore
...
def test_each_user_gets_their_own_codex_credential_root(
    ...
    guarantee unguarded.
    """
    from smarttutor.multi_user import paths as paths_module
    from smarttutor.multi_user.context import reset_current_user, set_current_user
