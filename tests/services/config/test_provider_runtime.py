...
def test_llm_ollama_profile_never_uses_local_as_api_key() -> None:
    catalog = _build_catalog(
        llm_profile={
            "id": "llm-p",
            "name": "Ollama",
            ...
            "api_version": "",
            "extra_headers": {},
            "models": [{"id": "llm-m", "name": "qwen", "model": "qwen3:8b"}],
        }
    )
...
def test_every_search_provider_has_a_registered_implementation() -> None:
    from smarttutor.services.search.providers import list_providers
