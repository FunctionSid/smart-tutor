...
async def run_test(
    *,
    ...
    from smarttutor.services.llm import config as config_module
    ...
    try:
        from smarttutor.services.llm.factory import complete

        t0 = time.perf_counter()
        resp = await complete(
            "Reply with exactly: HELLO_SMARTTUTOR",
    ...
    if test_stream:
        ...
        try:
            from smarttutor.services.llm.factory import stream
