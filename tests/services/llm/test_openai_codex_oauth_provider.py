...
from smarttutor.services.codex_auth.constants import CODEX_RESPONSES_URL
from smarttutor.services.codex_auth.contracts import CodexAuthError, CodexToken
from smarttutor.services.llm.exceptions import LLMProviderTransportError
from smarttutor.services.llm.provider_core import openai_codex_provider as module
...
@pytest.mark.asyncio
async def test_provider_uses_smarttutor_token_service_and_raw_sol_id(
