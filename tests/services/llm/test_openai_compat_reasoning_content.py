...
from smarttutor.services.llm.provider_core.openai_compat_provider import (
    OpenAICompatProvider as ServicesOpenAICompatProvider,
)
from smarttutor.services.provider_registry import find_by_name as find_service_provider
