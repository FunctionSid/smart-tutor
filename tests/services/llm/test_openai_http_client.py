...
def test_provider_core_passes_disable_ssl_http_client(monkeypatch: pytest.MonkeyPatch) -> None:
    from smarttutor.services.llm.provider_core import openai_compat_provider as provider_mod
...
def test_azure_provider_passes_disable_ssl_http_client(monkeypatch: pytest.MonkeyPatch) -> None:
    from smarttutor.services.llm.provider_core import azure_openai_provider as azure_mod
...
async def test_sdk_complete_passes_disable_ssl_http_client(
    ...
    from smarttutor.services.llm import executors
...
def test_embedding_sdk_passes_disable_ssl_http_client(
    ...
    from smarttutor.services.embedding.adapters import openai_sdk as embedding_mod
