...
def test_list_llm_options_is_redacted_and_marks_active_default():
    ...
    assert payload["options"][0]["provider_category"] == "cloud"
    assert payload["options"][2]["provider"] == "ollama"
    assert payload["options"][2]["provider_category"] == "local"
    assert payload["options"][2]["provider_mode"] == "local"
