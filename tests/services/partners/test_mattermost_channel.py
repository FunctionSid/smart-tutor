...
from smarttutor.partners.channels import mattermost as mm_module
from smarttutor.partners.channels.mattermost import MattermostChannel, MattermostConfig
