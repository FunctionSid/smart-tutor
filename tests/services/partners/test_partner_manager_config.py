...
from smarttutor.services.partners.manager import PartnerConfig, PartnerManager
from smarttutor.services.partners.workspace import DEFAULT_SOUL, read_soul
