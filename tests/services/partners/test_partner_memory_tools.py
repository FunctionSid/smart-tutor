...
from smarttutor.multi_user.paths import get_admin_path_service, user_context
from smarttutor.partners.config.paths import get_partner_sessions_dir, get_partner_workspace
...
def _fresh_memory_singleton(monkeypatch):
    ...
    from smarttutor.services.memory import store
...
def test_assigned_users_get_private_relationship_memory(partners_root: Path) -> None:
    ...
    from smarttutor.multi_user.paths import get_current_path_service, scope_for_user
