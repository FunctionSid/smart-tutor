...
from smarttutor.partners.channels import weixin as weixin_mod
from smarttutor.partners.channels.registry import discover_all, discover_channel_names
from smarttutor.partners.channels.weixin import (
...
class TestOutbound:
    ...
    async def test_send_text_posts_weixin_message(self, state_dir):
        ...
        assert body["msg"]["client_id"].startswith("smarttutor-")
