...
from smarttutor.services.rag.pipelines.graphrag import storage as graphrag_storage
from smarttutor.services.rag.pipelines.pageindex import storage as pageindex_storage
...
def test_llamaindex_doc_count_cached_until_file_changes(
    ...
    from smarttutor.services.rag.index_probe import _read_json
    ...
    monkeypatch.setattr("smarttutor.services.rag.index_probe._read_json", counting_read)
