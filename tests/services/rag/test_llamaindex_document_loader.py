...
def _install_stub_parse_service(monkeypatch, results: dict[str, "object"]) -> None:
    ...
    """
    import smarttutor.services.parsing as parsing
...
def test_loader_routes_parser_files_through_active_parse_engine(
    ...
    from smarttutor.services.rag.pipelines.llamaindex.document_loader import (
...
def test_loader_indexes_images_extracted_from_parsed_document(
    ...
    from smarttutor.services.parsing.types import ParsedDocument
    from smarttutor.services.rag.pipelines.llamaindex import document_loader as loader_module
