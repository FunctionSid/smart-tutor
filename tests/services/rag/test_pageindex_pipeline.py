...
from smarttutor.services.rag.factory import get_pipeline, normalize_provider_name
from smarttutor.services.rag.index_versioning import resolve_storage_dir_for_read
from smarttutor.services.rag.pipelines.pageindex import client as client_mod
from smarttutor.services.rag.pipelines.pageindex import storage
from smarttutor.services.rag.pipelines.pageindex.client import PageIndexClient
from smarttutor.services.rag.pipelines.pageindex.config import PageIndexConfig
...
def test_factory_dispatches_by_provider(tmp_path, monkeypatch) -> None:
    ...
    from smarttutor.services.rag.pipelines.llamaindex.pipeline import LlamaIndexPipeline
...
def test_pageindex_ready_omits_embedding_identity(tmp_path, monkeypatch) -> None:
    import smarttutor.knowledge.manager as manager_module
    from smarttutor.knowledge.manager import KnowledgeBaseManager
    from smarttutor.services.rag import embedding_signature as signature_module
