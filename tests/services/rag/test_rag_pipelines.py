...
import smarttutor.services.rag.service as rag_service_module
from smarttutor.services.rag.service import RAGService
from smarttutor.services.rag.smart_retriever import SmartRetriever
...
async def test_search_filters_noisy_vector_and_embedding_logs(
    ...
    async def search_with_noisy_logs(query: str, kb_name: str, **kwargs) -> Dict[str, Any]:
        ...
        logging.getLogger("smarttutor.services.embedding.adapters.openai_compatible").info(
