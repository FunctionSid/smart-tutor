...
if os.name != "posix":
    pytest.skip(
        "sandbox argv execution tests require POSIX command paths",
...
from smarttutor.services.sandbox.runner import server as runner_server
from smarttutor.services.sandbox.spec import ExecRequest
...
def test_the_sidecar_sends_both_spellings() -> None:
    ...
    import smarttutor.services.sandbox.backends as backends_module
