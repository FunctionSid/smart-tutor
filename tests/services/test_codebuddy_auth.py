...
from smarttutor.services import codebuddy_auth
from smarttutor.services.codebuddy_auth import CodeBuddyAuthService
...
async def test_status_accepts_ide_session_without_the_sdk(tmp_path, monkeypatch) -> None:
    ...
    monkeypatch.setattr("smarttutor.services.codebuddy_credentials.probe_account", _account_label)
...
async def test_logout_explains_that_an_ide_session_ends_in_the_ide(tmp_path, monkeypatch) -> None:
    """SmartTutor never ends a session it does not own.
