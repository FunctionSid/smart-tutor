...
from smarttutor.services.generation_http import (
    GenerationProviderError,
    build_auth_headers,
    join_api_path,
)
from smarttutor.services.imagegen import generate_image
from smarttutor.services.imagegen.adapters.chat_completions import ChatCompletionsImagegenAdapter
from smarttutor.services.imagegen.adapters.openai_compat import OpenAICompatImagegenAdapter
from smarttutor.services.imagegen.config import ImagegenConfig
from smarttutor.services.videogen import generate_video, probe_video
from smarttutor.services.videogen.adapters.async_task import AsyncTaskVideogenAdapter
...
async def test_imagegen_tool_saves_public_artifact(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    import smarttutor.services.imagegen as imagegen_mod
    from smarttutor.services.path_service import get_path_service
    from smarttutor.tools.media_gen_tool import ImagegenTool
...
async def test_videogen_tool_forwards_progress_and_saves(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    from smarttutor.services.path_service import get_path_service
    import smarttutor.services.videogen as videogen_mod
    from smarttutor.tools.media_gen_tool import VideogenTool
