...
from smarttutor.services.parsing.engines.mineru import cloud as mineru_cloud
from smarttutor.services.parsing.engines.mineru import config as mineru_config
...
def test_parse_pdf_to_workdir_dispatches_local(
    ...
    from smarttutor.services.parsing.engines.mineru import local as pdf_parser
