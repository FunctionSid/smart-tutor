...
def _load_question_extractor_module():
    ...
    stubbed_modules = {
        "smarttutor.services.config": {"get_agent_params": lambda *_args, **_kwargs: {}},
        "smarttutor.services.llm": {"complete": lambda *_args, **_kwargs: None},
        "smarttutor.services.llm.capabilities": {
            "supports_response_format": lambda *_args, **_kwargs: False
        },
        "smarttutor.services.llm.config": {"get_llm_config": lambda: None},
        "smarttutor.utils.json_parser": {"parse_json_response": lambda *_args, **_kwargs: {}},
    }
