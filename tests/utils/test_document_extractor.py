"""Tests for smarttutor.utils.document_extractor."""
...
from smarttutor.utils import document_extractor as document_extractor_module
...
class TestExtractDocumentsFromRecords:
    ...
    def test_limits_come_from_settings_layer(self, monkeypatch) -> None:
        ...
        from smarttutor.services.config import runtime_settings as rs
