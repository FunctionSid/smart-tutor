...
const PIP_HINT: Record<string, string> = {
  docling: "pip install smarttutor[parse-docling]",
  markitdown: "pip install smarttutor[parse-markitdown]",
  pymupdf4llm: "pip install smarttutor[parse-pymupdf4llm]",
  liteparse: "pip install smarttutor[parse-liteparse]",
};
  ...
  return (
    ...
    >
      <SettingRow
        ...
        description={t(
          "Reserved — uses Smart Tutor's vision model to caption images during conversion.",
        )}
        control={
          <Toggle
            checked={llmImages}
