  ...
  return (
    <div className="space-y-10">
      <SettingsPageHeader
        ...
        description={t(
          "Read assistant replies aloud from the chat speaker button. Use global/local tools such as Edge TTS, Piper, pyttsx3, or Windows voices, or an OpenAI-compatible cloud provider.",
        )}
      />
