...
const SPLIT_RATIO_KEY = "smarttutor.co_writer.split_ratio";
const SYNC_SCROLL_KEY = "smarttutor.co_writer.sync_scroll";
const LOCAL_DRAFT_PREFIX = "smarttutor.co_writer.draft.";
