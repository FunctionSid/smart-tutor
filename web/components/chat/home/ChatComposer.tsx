...
export default memo(function ChatComposer({
  ...
  /** Max times Smart Tutor may consult the selected agent this turn. */
  ...
  const sendTitle =
    sendState === "blocked"
      ...
      : sendLabel;
  const voiceAnnouncement = recorder.error
    ? t("Voice input error: {{message}}", { message: recorder.error })
    : recorder.announcement
      ? t(recorder.announcement)
    : recorder.state === "recording"
      ? t("Recording. Press again to stop.")
