 ...
 * (see smarttutor/services/provider_registry.py). SVGs are vendored from
...
const PROVIDER_ICONS: Record<string, { file: string; mono?: boolean }> = {
  ...
  krutrim: { file: "openai.svg", mono: true },
  ...
  // smarttutor/services/config/provider_runtime.py). brave/duckduckgo/searxng
