...
export const ACTIVE_SESSION_STORAGE_KEY = "smarttutor.activeSessionId.tab";
export const LANGUAGE_STORAGE_KEY = "smarttutor-language";
export const RESPONSE_LANGUAGE_STORAGE_KEY = "smarttutor-response-language";
export const SIDEBAR_COLLAPSED_STORAGE_KEY = "smarttutor.sidebarCollapsed";
export const CHAT_RESPONSE_TIMEOUT_STORAGE_KEY =
  "smarttutor.chatResponseTimeout";
export const CODE_BLOCK_THEME_STORAGE_KEY = "smarttutor.code-block-theme";
export const CODE_BLOCK_SHOW_LINE_NUMBERS_STORAGE_KEY =
  "smarttutor.code-block-show-line-numbers";
export const CODE_BLOCK_WRAP_LONG_LINES_STORAGE_KEY =
  "smarttutor.code-block-wrap-long-lines";
...
export const ACTIVE_SESSION_EVENT = "smarttutor:active-session";
export const LANGUAGE_EVENT = "smarttutor:language";
export const RESPONSE_LANGUAGE_EVENT = "smarttutor:response-language";
export const SIDEBAR_COLLAPSED_EVENT = "smarttutor:sidebar-collapsed";
export const CODE_BLOCK_SETTINGS_EVENT = "smarttutor:code-block-settings";
