...
const SESSION_KEY_PREFIX = "smarttutor.voiceAutoplay.session"; // "on" | "off"
const PROMPTED_KEY_PREFIX = "smarttutor.voiceAutoplay.prompted"; // "1"
const GLOBAL_EVENT = "smarttutor:voice-autoplay-global";
const SESSION_EVENT = "smarttutor:voice-autoplay-session";
