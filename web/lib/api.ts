 ...
 * `SMARTTUTOR_API_BASE_URL` (exported by the container entrypoint from
...
/**
 * Parse a "SMARTTUTOR_AUTH_ENABLED"-style flag at runtime.
 *
...
// The browser bundle never sees `SMARTTUTOR_AUTH_ENABLED` (it isn't a
