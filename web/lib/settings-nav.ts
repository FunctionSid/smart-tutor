...
const AGENT_CHILDREN: SettingsLeaf[] = [
  {
    ...
    blurb: {
      zh: "Smart Tutor 调用本机 Claude Code 时的模型、推理强度与运行参数。",
  ...
  },
  {
    ...
    blurb: {
      zh: "Smart Tutor 调用本机 Codex 时的模型、推理强度与运行参数。",
  ...
  },
  {
    ...
    blurb: {
      zh: "Smart Tutor 调用本机 Gemini CLI 时的模型与运行参数。",
  ...
  },
  {
    ...
    blurb: {
      zh: "Smart Tutor 调用本机 Kimi CLI 时的模型与运行参数。",
  ...
  },
  {
    ...
    blurb: {
      zh: "Smart Tutor 调用本机 opencode 时的模型、推理强度与运行参数。",
  ...
  },
  {
    ...
    blurb: {
      zh: "Smart Tutor 调用本机 MiMo Code 时的模型、推理强度与运行参数。",
