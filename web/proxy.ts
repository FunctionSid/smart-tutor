...
// exports `SMARTTUTOR_API_BASE_URL` from `data/user/settings/system.json`
...
const API_BASE_URL =
  process.env.SMARTTUTOR_API_BASE_URL ?? "http://127.0.0.1:8001";

const AUTH_ENABLED = parseAuthEnabled(process.env.SMARTTUTOR_AUTH_ENABLED);
